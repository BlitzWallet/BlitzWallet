...
export default function ChildClaimInfo() {
  ...
  const bullets = [
    { icon: 'Check', text: t('settings.childAccounts.claim.info.bullet1') },
    { icon: 'Info', text: t('settings.childAccounts.claim.info.bullet2') },
    {
      icon: 'TriangleAlert',
      text: t('settings.childAccounts.claim.info.bullet3'),
    },
  ];
  ...
  return (
    <GlobalThemeView useStandardWidth={true}>
      <CustomSettingsTopBar
        label={t('settings.childAccounts.claim.info.navTitle')}
      />
