    ...
    <GlobalThemeView useStandardWidth={true}>
      ...
      <View style={styles.container}>
        <SettingsItemWithSlider
          ...
          settingDescription={
            'LRC-20 is Spark’s native token. Enabling LRC-20 lets you send and receive tokens on the Spark network.\n\nBlitz is a Bitcoin focused wallet. We do not promote or endorse the use of tokens. This feature exists because we believe users should have the freedom to use the technology they want to use. If you decide to use tokens, please understand they are speculative and have no real value.'
          }
          handleSubmit={() =>
